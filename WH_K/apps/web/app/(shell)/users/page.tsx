...
const ROLE_LABEL: Record<string, string> = {
  WAREHOUSE_MANAGER: 'ผู้จัดการคลังโรงครัว',
  WAREHOUSE_STAFF: 'พนักงานคลังโรงครัว',
  REQUESTER: 'ผู้เบิก',
    ...
    <div className="mx-auto max-w-6xl">
      ...
      <Card className="overflow-hidden">
        <div className="grid grid-cols-[100px_1fr_140px_100px_80px] gap-2 bg-[#fafafb] px-5 py-2.5 text-[11.5px] font-bold uppercase text-muted">
          <span>รหัส</span><span>ชื่อ</span><span>บทบาท</span><span>คลังโรงครัว</span><span className="text-right">สถานะ</span>
        </div>
        {isLoading ? (
