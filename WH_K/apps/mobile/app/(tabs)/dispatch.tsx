              ...
              <View key={pos.id} style={styles.catalogRow}>
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.itemMeta}>
                    {(pos as any).item?.sku} · คลังโรงครัว {(pos as any).warehouse?.code} · เหลือ {pos.onHand}
                  </Text>
                </View>
                <TouchableOpacity
          ...
          {cart.map(c => (
            <View key={c.position.id} style={styles.cartRow}>
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.itemMeta}>คลังโรงครัว {(c.position as any).warehouse?.code}</Text>
              </View>
